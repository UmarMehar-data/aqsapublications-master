...
@section('title', 'Book Detail Page | Aqsa Publications')
    ...
    <div class="page-header border-bottom">
        <div class="container">
            <div class="d-md-flex justify-content-between align-items-center py-4">
                <h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg">Shop Book</h1>
                <nav class="woocommerce-breadcrumb font-size-2">
                    ...
                    <a href="v1.html" class="h-primary">Shop</a>
                        ...
                        <div class="col-md-5 woocommerce-product-gallery woocommerce-product-gallery--with-images images">
                            <figure class="woocommerce-product-gallery__wrapper pt-8 mb-0">
                                <div class="js-slick-carousel u-slick"
                                    ...
                                    <div class="js-slide">
                                        <img src="{{ url('storage') }}/{{ $book->thumbnail }}" alt="Image Description"
                            ...
                            <div class="space-top-2 px-4 px-xl-7 border-bottom pb-5">
                                ...
                                <p class="price font-size-22 font-weight-medium mb-3">
                                    <span class="woocommerce-Price-amount amount">
                                        <span class="woocommerce-Price-currencySymbol">RS:</span>{{ $book->prices->count() ? $book->prices[0]->net_price : '' }}
                                    </span>
                                    {{-- <span class="woocommerce-Price-amount amount">
                                ...
                                <form class="cart d-md-flex align-items-center"
                                    ...
                                    <div class="quantity mb-4 mb-md-0 d-flex align-items-center">
                                        ...
                                        <input type="hidden" value="{{ $book->prices->count() ? $book->prices[0]->net_price : '' }}" id="bookPrice">
                                    </div>
                                    <button type="button" id="addToCart" name="add-to-cart" value="7145"
                            ...
                            <div class="px-4 px-xl-7 py-5 d-flex align-items-center">
                                <ul class="list-unstyled nav">
                                    <li class="mr-6 mb-4 mb-md-0">
                                        <a href="#" class="h-primary"><i class="flaticon-heart mr-2"></i>
                                            Add to Wishlist</a>
                                    </li>
                                    <li class="mr-6">
                                ...
                                <div class="row">
                                    <div class="col-xl-8 offset-xl-2">
                                        <div
                                            ...
                                            @php
                                                $detailDescription = html_entity_decode($book->body);
                                        ...
                                        <div
                                            ...
                                            <div class="row mb-8">
                                                <div class="col-md-6 mb-6 mb-md-0">
                                                    ...
                                                    <div class="d-md-flex">
                                                        <button type="button"
                                                            class="btn btn-outline-dark rounded-0 px-5 mb-3 mb-md-0">See
                                                            all reviews</button>
                                                        <button type="button"
                                            ...
                                            <ul class="list-unstyled mb-8">
                                                ...
                                                <li class="mb-4 pb-5 border-bottom">
                                                    ...
                                                    <p class="mb-4 text-lh-md">Awesome book, great price, fast
                                                        delivery. Thanks so much.</p>
                                                    <div class="text-gray-600 mb-4">Staci, February 22, 2020 </div>
                                                    <ul class="nav">
                                                        <li class="mr-7">
                                                            <a href="#"
                                            ...
                                            <div class="js-form-message form-group mb-4">
                                                <label for="descriptionTextarea"
                                                    class="form-label text-dark h6 mb-3">Details please! Your review
                                            ...
                                            <div class="d-flex">
                                                <button type="submit"
                                                    class="btn btn-dark btn-wide rounded-0 transition-3d-hover">Submit
                                                    Review</button>
                                            </div>
                                ...
                                <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div
                                        ...
                                        <div class="woocommerce-loop-product__thumbnail">
                                            <a href="single-product-v3.html" class="d-block"><img
                                        ...
                                        <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                                    href="single-product-v3.html">Paperback</a></div>
                                            <h2
                                                class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                <a href="single-product-v3.html">Think Like a Monk: Train Your Mind
                            ...
                            <div class="product">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div
                                        ...
                                        <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                                    href="single-product-v3.html">Kindle Edition</a></div>
                                            <h2
                                                class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                <a href="single-product-v3.html">The Overdue Life of Amy Byler</a>
                                            </h2>
                                            <div class="font-size-2  mb-1 text-truncate"><a
                                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                                ...
                                <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div
                                        ...
                                        <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                            ...
                                            <h2
                                                class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                <a href="single-product-v3.html">All You Can Ever Know: A Memoir</a>
                                            </h2>
                                            <div class="font-size-2  mb-1 text-truncate"><a
                                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                                                    class="text-gray-700">Jay Shetty</a></div>
                                ...
                                <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div
                                        ...
                                        <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                            ...
                                            <h2
                                                class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                <a href="single-product-v3.html">The Last Sister (Columbia River Book
                                                    1)</a>
                                            </h2>
                                            <div class="font-size-2  mb-1 text-truncate"><a
                                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
