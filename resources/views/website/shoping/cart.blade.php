...
@section('title', 'Cart Items| Aqsa Publications')
...
.quantity__plus:visited {
  color: #fff;
    ...
    <div class="page-header border-bottom">
        <div class="container">
            <div class="d-md-flex justify-content-between align-items-center py-4">
                <h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg">Cart Items</h1>
            </div>
        </div>
    </div>
    ...
    <div class="site-content bg-punch-light overflow-hidden" id="content">
        <div class="container">
            <header class="entry-header space-top-2 space-bottom-1 mb-2">
                <h1 class="entry-title font-size-7">Your cart:  items</h1>
            </header>
            <div class="row pb-8">
                            ...
                            <div class="entry-content">
                                <div class="woocommerce">
                                    <form class="woocommerce-cart-form table-responsive" action="#" method="post">
                                        <table
                                            class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" id="CartTable">
                                            <thead>
                                                <tr>
                                                ...
                                                @foreach ($carts as $item)
                                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                                        ...
                                                        <td class="product-quantity" data-title="Quantity">
                                                            @if ($item->book->qty > $item->book_qty)
                                                                <div class="quantity">
                                                                    <a href="#" class="quantity__minus" id="changeQty"><span>-</span></a>
                                                                    <input name="book_qty" type="text" class="quantity__input" value="{{ $item->book_qty }}">
                                                                    <a href="#" class="quantity__plus" id="changeQty"><span>+</span></a>
                                                                </div>
                                                                @else
                                                                    Out Of Stock
                                                            @endif
                                                        ...
                                                        @endphp
                                                        {{-- end Calculating the price --}}
                                                        <td class="product-subtotal" data-title="Total">
                                                            <span class="woocommerce-Price-amount amount"><span
                                                                    class="woocommerce-Price-currencySymbol">Rs:</span>{{ $total }}</span>
                                                        </td>
                                                        <td class="product-remove">
                                                            <input type="hidden" value="{{ $item->id }}">
                                                            <input type="hidden" name="book_id" value="{{ $item->book_id }}">
                                                            <a href="#" class="remove" id="removeCartItem" aria-label="Remove this item">
                ...
                <div id="secondary" class="sidebar cart-collaterals order-1 col-sm-3" role="complementary">
                                    ...
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            ...
                                            <td data-title="Subtotal"><span class="woocommerce-Price-amount amount"><span
                                                        class="woocommerce-Price-currencySymbol">Rs:</span>{{ $total }}</span></td>
                                        </tr>
                                ...
                                <tbody>
                                    <tr class="order-total">
                                        ...
                                        <td data-title="Total"><strong><span class="woocommerce-Price-amount amount"><span
                                                        class="woocommerce-Price-currencySymbol">Rs:</span>{{ $total }}</span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    @include('website.shoping.js.index')
