<nav class="navbar ms-navbar">
    ...
    <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0"
            href="#"><img src="{{ asset('admin_assets') }}/img/m-logo-1.png"
                alt="logo"> </a>
    </div>
                ...
                <li class="ms-scrollable ms-dropdown-list">
                    <a class="media p-2" href="#">
                        <div class="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
                            <img src="{{ asset('admin_assets') }}/img/project-management/people-5.jpg" class="ms-img-round"
                                alt="people">
                        </div>
                ...
                <li class="ms-scrollable ms-dropdown-list">
                    ...
                    <a class="media p-2" href="#">
                        <div class="media-body">
                            ...
                            <p class="fs-10 my-1 text-disabled"><i class="material-icons">access_time</i> 45 minutes
                                ago</p>
                        </div>
                    </a>
                    <a class="media p-2" href="#">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
            <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false"> <img class="ms-user-img ms-img-round float-right"
                    src="{{ asset('admin_assets') }}/img/project-management/people-5.jpg" alt="people"> </a>
            <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
                <li class="dropdown-menu-header">
                    <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Welcome, Farisha</span>
                    </h6>
                </li>
                <li class="dropdown-divider"></li>
                ...
                <li class="dropdown-menu-footer">
                    {{-- <a class="media fs-14 p-2" href="{{ route('admin.admin-logout') }}"> <span><i --}}
