                    ...
                    <div class="ms-chat-header px-3">
                        <div class="ms-chat-user-container media clearfix">
                            <div class="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                                <img src="assets/img/project-management/people-5.jpg" class="ms-img-round"
                                    alt="people">
                            </div>
                                ...
                                <ul class="ms-scrollable ms-quickbar-container">
                                    <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                        <div
                                            ...
                                            <img src="assets/img/project-management/people-11.jpg"
                                    ...
                                    <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                        <div
                                            ...
                                            <img src="assets/img/project-management/people-10.jpg"
                                                class="ms-img-round" alt="people">
                                        </div>
                                        <div class="media-body ms-chat-user-info mt-1">
                                    ...
                                    <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                        <div
                                            ...
                                            <img src="assets/img/project-management/people-8.jpg" class="ms-img-round"
                                                alt="people">
                                        </div>
                                        <div class="media-body ms-chat-user-info mt-1">
                                    ...
                                    <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                        <div class="ms-chat-status ms-status-busy ms-chat-img mr-3 align-self-center">
                                            <img src="assets/img/project-management/people-7.jpg" class="ms-img-round"
                                                alt="people">
                                        </div>
                                        <div class="media-body ms-chat-user-info mt-1">
                                    ...
                                    <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                        <div
                                            class="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                                            <img src="assets/img/project-management/people-12.jpg"
                                                class="ms-img-round" alt="people">
                                        </div>
                                        <div class="media-body ms-chat-user-info mt-1">
                                ...
                                <ul class="ms-scrollable ms-quickbar-container">
                                    <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                        <div class="ms-chat-img mr-3 align-self-center">
                                            <img src="assets/img/project-management/people-3.jpg" class="ms-img-round"
                                                alt="people">
                                        </div>
                                        <div class="media-body ms-chat-user-info mt-1">
                                            ...
                                            <ul class="ms-group-members clearfix mt-3 mb-0">
                                                <li> <img src="assets/img/project-management/people-3.jpg"
                                                        alt="member"> </li>
                                                <li> <img src="assets/img/project-management/people-5.jpg"
                                                        alt="member"> </li>
                                                <li> <img src="assets/img/project-management/people-7.jpg"
                                                        alt="member"> </li>
                                    ...
                                    <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                        ...
                                        <div class="media-body ms-chat-user-info mt-1">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu
                                                turpis. Nunc</p>
                                            <ul class="ms-group-members clearfix mt-3 mb-0">
                                                <li> <img src="assets/img/project-management/people-11.jpg"
                                                        alt="member"> </li>
                                                <li> <img src="assets/img/project-management/people-8.jpg"
                                                        alt="member"> </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                        ...
                                        <div class="media-body ms-chat-user-info mt-1">
                                            ...
                                            <ul class="ms-group-members clearfix mt-3 mb-0">
                                                ...
                                                <li> <img src="assets/img/project-management/people-8.jpg"
                                                        alt="member"> </li>
                                                <li> <img src="assets/img/project-management/people-10.jpg"
                                                        alt="member"> </li>
            ...
            <div role="tabpanel" class="tab-pane" id="qa-email">
                ...
                <div class="ms-email-container">
                    ...
                    <div class="ms-qa-options">
                        <a href="#" class="btn btn-primary w-100 mt-0 has-icon"> <i
                                class="flaticon-pencil"></i> Compose Email </a>
                    </div>

                    <ul class="ms-scrollable ms-quickbar-container">
                        <li class="p-3  media ms-email clearfix">
                            <div class="ms-email-img mr-3 ">
                                <img src="assets/img/project-management/people-12.jpg" class="ms-img-round"
                                    alt="people">
                            </div>
                    ...
                    <ul class="ms-todo-list">
                        <li class="ms-card ms-qa-card ms-deletable">
                            ...
                            <div class="ms-card-footer clearfix">
                                <a href="#" class="text-disabled mr-2"> <i class="flaticon-archive"> </i>
                                    Archive </a>
                        ...
                        <div class="ms-card ms-qa-card ms-deletable">
                            ...
                            <div class="ms-card-footer clearfix">
                                ...
                                <div class="ms-note-editor float-right">
                                    ...
                                    <a href="#" class="text-disabled  ms-delete-trigger"> <i
                                            class="flaticon-trash"> </i> Delete </a>
                                </div>
            ...
            <div role="tabpanel" class="tab-pane" id="qa-notes">
                ...
                <div class="ms-quickbar-container ms-scrollable">
                    ...
                    <div class="ms-card ms-qa-card ms-deletable">
                        ...
                        <div class="ms-card-body">
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vulputate urna in faucibus
                                venenatis. Etiam at dapibus neque,
                                vel varius metus. Pellentesque eget orci malesuada, venenatis magna et
                            </p>
                            <ul class="ms-note-members clearfix mb-0">
                                <li class="ms-deletable"> <img src="assets/img/project-management/people-12.jpg"
                                        alt="member"> </li>
                                <li class="ms-deletable"> <img src="assets/img/project-management/people-11.jpg"
                                        alt="member"> </li>
                            </ul>
                        </div>
                        <div class="ms-card-footer clearfix">
                                    ...
                                    <li class="ms-scrollable ms-dropdown-list ms-members-list">
                                        <a class="media p-2" href="#">
                                            <div class="mr-2 align-self-center">
                                                <img src="assets/img/project-management/people-8.jpg"
                                                    class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body">
                                                <span>John Doe</span>
                    ...
                    <div class="ms-card ms-qa-card ms-deletable">
                        ...
                        <div class="ms-card-body">
                            ...
                            <ul class="ms-note-members clearfix mb-0">
                                <li class="ms-deletable"> <img src="assets/img/project-management/people-7.jpg"
                                        alt="member"> </li>
                            </ul>
                        </div>
                        <div class="ms-card-footer clearfix">
                ...
                <div class="ms-quickbar-container text-center ms-invite-member">
                    ...
                    <form>
                        <div class="ms-form-group">
                            <input type="text" placeholder="Member Email" class="form-control"
                                name="invite-email" value="">
                        </div>
                        <div class="ms-form-group">
